...
import dev.hexnowloading.dungeonnowloading.block.client.renderer.SkullWithDnlOverlayRenderer;
...
public class DNLForgeClientEvents {
    ...
    public static void onRegisterRenderer(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(BlockEntityType.SKULL, ctx -> new SkullWithDnlOverlayRenderer(ctx));
